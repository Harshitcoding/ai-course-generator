...
const FinishScreen = ({params}) => {
  ...
  return (
    <div className="px-10 md:px-20 lg:px-44 my-7">
        ...
        border-2 p-2 rounded flex gap-5 items-center">{process.env.NEXT_PUBLIC_HOST_NAME}/course/view/{course?.courseId} <HiOutlineClipboardDocumentCheck className="text-primary h-5 w-5 cursor-pointer"
